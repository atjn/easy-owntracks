...
# This is responsible for initialization of the OwnTracks container.
# It ensures that all necessary folders and files exist before the other services are started,
# and it configures the services to run correctly. It is only run once on startup.
